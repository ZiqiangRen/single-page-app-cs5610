...
const allCourses = courseService.findAllCourses();
const topicId = allCourses[0].modules[0].lessons[0].topics[0].id;

const widgets2 = courseService.findWidgets(topicId);
